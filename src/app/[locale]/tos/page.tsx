  ...
  const features = [
    {
      ...
      title: "APIs RESTful",
      description:
        "Endpoints bem estruturados e documentados para integração rápida e eficiente com sua aplicação.",
    },
    {
      icon: Database,
      title: "Gestão de Dados",
      description:
        "Armazenamento seguro e organizado de todas as informações transacionais e operacionais.",
    },
    {
      icon: Settings,
      title: "Configuração Flexível",
      description:
        "Personalize regras de negócio, limites e parâmetros operacionais através de interface intuitiva.",
    },
    {
      icon: Plug,
      title: "Integração Simples",
      description:
        "APIs REST padronizadas com documentação completa para integração direta em qualquer linguagem.",
    },
    {
      icon: Terminal,
      title: "Webhook Support",
      description:
        "Receba notificações em tempo real sobre eventos importantes em suas transações.",
    },
    {
      icon: BookOpen,
      title: "Documentação Completa",
      description:
        "Guias passo a passo, exemplos de código e referência completa da API.",
    },
  ];
  ...
  const tosFeatures = [
    {
      ...
      description:
        "Visão consolidada de todas as operações com métricas em tempo real e indicadores de performance.",
      metric: "100+ Métricas",
    },
    {
      icon: Layers,
      ...
      description:
        "Controle multi-nível de usuários com permissões granulares e auditoria completa.",
    ...
    },
    {
      ...
      description:
        "Workflows automatizados para aprovações, notificações e processos operacionais.",
      metric: "Automação de rotinas",
    },
  ];
  ...
  return (
    <main>
      ...
      <section
        ...
        style={{ height: "calc(100vh - 88px)", maxHeight: "900px" }}
      >
        ...
        >
          ...
          >
            APIs e <span className="no-gradient">Tamborine</span> Operation
            System
          </motion.h1>
          ...
          >
            Conecte sua aplicação ao ecossistema Tamborine através de APIs
            robustas e gerencie todas as operações com nosso sistema
            proprietário TOS - a plataforma mais completa para administração
            financeira.
          </motion.p>
          ...
          >
            <Link className="button px-8 py-4 text-lg font-medium" target="_blank" href={"https://docs.tamborine.app/#section/Autenticacao"}>
              Documentação da API
            </Link>
            <Link href={'/contato'} className="px-8 py-4 text-lg font-medium border border-[var(--color-primary)] rounded-full text-[var(--color-primary)] hover:bg-[var(--color-primary)]/10 transition-colors">
              Demo do TOS
            </Link>
          </motion.div>
        </motion.div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-lg text-gradient-hero max-w-3xl mx-auto">
              Integre rapidamente os serviços Tamborine em sua aplicação com
              nossas APIs bem documentadas, seguras e fáceis de implementar.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gradient-hero mb-8">
                Nossa API REST segue os padrões da indústria com autenticação
                JWT, rate limiting e documentação OpenAPI completa.
              </p>
      ...
      <section className="py-20 bg-solutions">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-lg text-gradient-hero max-w-3xl mx-auto">
              O TOS é nossa plataforma proprietária que centraliza toda a gestão
              operacional, oferecendo controle total sobre suas operações
              financeiras.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-horizontal">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-lg text-gradient-hero max-w-3xl mx-auto">
              Implementar nossa solução é simples e rápido. Siga estes passos
              para estar operacional em pouco tempo.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Crie sua conta e obtenha as chaves de acesso para ambiente de desenvolvimento.",
              },
              {
                step: "02",
                title: "Implementação",
                description:
                  "Integre diretamente via REST API seguindo nossa documentação completa.",
              },
              {
                step: "03",
                title: "Testes",
                description:
                  "Realize testes completos em nosso ambiente sandbox com dados simulados.",
              },
              {
                step: "04",
                title: "Produção",
                description:
                  "Migre para ambiente de produção e comece a processar transações reais.",
              },
            ].map((step, index) => (
              <motion.div
                key={index}
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gradient-hero mb-8">
                Com apenas algumas linhas de código, você pode integrar todos os
                nossos serviços e começar a processar pagamentos imediatamente.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      Endpoints bem documentados para todas as linguagens de
                      programação.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      Repositório GitHub com exemplos de implementação
                      completos.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      Equipe de desenvolvedores prontos para ajudar na
                      integração.
                    </p>
                  </div>
                </div>
